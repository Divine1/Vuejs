                  ...
                  <div>
                      <div>
                          <form>
                              ...
                              <input @keyup.enter="search()" autofocus class="searchbox" placeholder="Search Mongo" type="text" v-model="text" />
                              <div class="div_icon">
  ...
  methods:{
      ...
      triggerAjax(){
        ...
        //http://localhost:7001/marklogic/getresults?searchterm=product
          ...
          var url = "http://infosyspoc.com:7001/mongo/getresults?searchterm="+this.text;
          axios.get(url, {
            headers: {
